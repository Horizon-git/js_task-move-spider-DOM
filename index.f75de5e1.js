...
document.addEventListener("click", (e)=>{
    ...
    const topSpiderPosition = Math.min(Math.max(e.offsetY - spider.clientHeight / 2, 0), maxTop);
    const leftSpiderPosition = Math.min(Math.max(e.offsetX - spider.clientWidth / 2, 0), maxLeft);
